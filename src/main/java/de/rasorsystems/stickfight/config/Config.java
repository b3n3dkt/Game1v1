package de.rasorsystems.stickfight.config;

import de.rasorsystems.stickfight.utils.FileBuilder;

public class Config {

    FileBuilder fileBuilder;
    String path = "plugins//StickFight//";
    ...
    public void createNewConfig(){
        ...
        this.fileBuilder.setValue("mysql.database", "StickFight");
